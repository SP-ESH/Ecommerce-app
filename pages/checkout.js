        ...
        <Layout>
            ...
            <form action="/api/checkout" method="POST">
                <div className="mt-4">
                    ...
                    <input name="city" value={city} onChange={e => setCity(e.target.value)} className="bg-gray-100 w-full rounded-xl px-4 py-2 mb-2" type="text" placeholder="City and postal code" />
                ...
                <button type="submit" className="bg-emerald-500 px-5 text-white w-full  py-2 rounded-xl font-bold my-4 shadow-emerald-300 shadow-lg">Pay total</button>
            </form>
        </Layout>
    )
}